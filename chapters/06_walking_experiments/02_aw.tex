...
\label{sec::421_cc}
As described in section \ref{sec::33_ip}, for the stereo block matching algorithm to work properly (equation \ref{eq::431_sad}), it is required to calibrate the cameras. We shortly verified this in figure \ref{fig::421_no_calib}, where we extracted a depth map from the uncalibrated stereo camera pair.
\begin{figure}[h!]
	\centering
