...
\begin{align}
	\bm{\delta}_N &= \frac{\partial L}{\partial \bm{x}_N} \circ f_N'(\bm{W}_N\bm{x}_{N-1}) \\
	\bm{\delta}_l &= \bm{W}^T_{l+1}\bm{\delta}_{t+1} \circ f_{l}'(\bm{W}_l\bm{x}_{l-1}),
...
\begin{align}
	\bm{W}_l^{t+1} = \bm{W}_l^t - \bm{\alpha}_{\bm{W}^t_l}\circ\frac{\partial L}{\partial \bm{W}^l}.
\end{align}