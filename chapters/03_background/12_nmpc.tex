...
\begin{align}
	...
	\end{pmatrix}
\end{align}
The control variable $\bm{U}_k$ at time step $k$ then takes the following form
\begin{align}
...
introduce fkp1 and the optimization variable, introduce canonical formulation and explain how terms that are not involved in the optimization can be neglected. how do the left and the right foot described in here with the foot selection?
