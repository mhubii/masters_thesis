...
\begin{figure}[h!]
	...
	[.4\linewidth]{\includegraphics[scale=.3]{chapters/09_image_processing_experiments/img/disp_no_calib.png}}
	\subcaptionbox{Confidence weighted least squares filtered disparity map.}%
	[.4\linewidth]{\includegraphics[scale=.3]{chapters/09_image_processing_experiments/img/wls_no_calib.png}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=.28]{chapters/09_image_processing_experiments/img/calib.png}
...
\begin{figure}[h!]
	...
	[.4\linewidth]{\includegraphics[scale=.25]{chapters/09_image_processing_experiments/img/rect.png}}
	\subcaptionbox{Rotated rectified images.}%
	[.4\linewidth]{\includegraphics[scale=.25]{chapters/09_image_processing_experiments/img/rect_line.png}}
...
\begin{figure}[h!]
	...
	[.4\linewidth]{\includegraphics[scale=.3]{chapters/09_image_processing_experiments/img/l_rgb.png}}
	\subcaptionbox{Right camera's view.}%
	[.4\linewidth]{\includegraphics[scale=.3]{chapters/09_image_processing_experiments/img/r_rgb.png}}
...
\begin{figure}[h!]
	...
	[.45\linewidth]{\includegraphics[scale=.2]{chapters/09_image_processing_experiments/img/disp_sad.png}}
	...
	[.45\linewidth]{\includegraphics[scale=.2]{chapters/09_image_processing_experiments/img/disp_sad_wls.png}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=.2]{chapters/09_image_processing_experiments/img/sigma_lambda.png}
