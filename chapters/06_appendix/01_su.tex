...
\end{enumerate}
\section{Simulated Robot Startup}
\label{sec::B2_ss}
...
The terminal user interface comes with the pattern generator, so there is no additional software that needs to be installed. Proceed as described below.
	...
	\begin{figure}[h!]
		...
		[.4\linewidth]{\includegraphics[scale=.22]{chapters/07_appendix/img/keyboard_mode.png}}
...
\begin{enumerate}
	...
	\begin{figure}[h!]
		\centering
		\subcaptionbox{Select the mode to run the pattern generator in.}%
		[.4\linewidth]{\includegraphics[scale=.22]{chapters/07_appendix/img/app_mode.png}}
		\subcaptionbox{App user interface.}%
		[.4\linewidth]{\includegraphics[scale=.22]{chapters/07_appendix/img/app_interface.png}}
	...
	\begin{figure}[h!]
		...
		[.3\linewidth]{\includegraphics[scale=.08]{chapters/07_appendix/img/slider.png}}
		\subcaptionbox{Settings activity.}%
		[.3\linewidth]{\includegraphics[scale=.08]{chapters/07_appendix/img/settings.png}}
		\subcaptionbox{Connect activity.}%
		[.3\linewidth]{\includegraphics[scale=.107]{chapters/07_appendix/img/connect_settings.png}}
