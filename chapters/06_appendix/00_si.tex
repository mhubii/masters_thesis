...
The simulation environment can be installed according to the \href{http://gazebosim.org/tutorials?tut=install_ubuntu&cat=install}{install instructions}. The main steps are
\begin{enumerate}
