...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=.28]{chapters/03_principles_of_machine_learning/img/calibration_process.png}
...
\begin{figure}[h!]
	\centering
	\captionbox{}%
	[.4\linewidth]{\includegraphics[scale=.2]{chapters/03_principles_of_machine_learning/img/gazebo_calib_left.jpg}}
	\captionbox{}%
	[.4\linewidth]{\includegraphics[scale=.2]{chapters/03_principles_of_machine_learning/img/gazebo_corners.jpg}}
