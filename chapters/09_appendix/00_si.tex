...
\begin{enumerate}
	...
	\begin{figure}[h!]
		...
		[.22\linewidth]{\includegraphics[scale=.06]{chapters/09_appendix/img/file_browser.png}}
		\subcaptionbox{Menu.}%
		[.22\linewidth]{\includegraphics[scale=.06]{chapters/09_appendix/img/installation_start.png}}
		\subcaptionbox{Installing.}%
		[.22\linewidth]{\includegraphics[scale=.06]{chapters/09_appendix/img/installation.png}}
		\subcaptionbox{Finished.}%
		[.22\linewidth]{\includegraphics[scale=.06]{chapters/09_appendix/img/installation_end.png}}
