...
text centered, anchor=north, text=black, text width=7cm, font=\small]
\tikzstyle{comment}=[rectangle, draw=black, rounded corners, fill=green!40, drop shadow,
text centered, anchor=north, text=black, text width=7cm, font=\small]
...
\begin{document}
	...
	\input{chapters/06_implementation_of_the_walking_pattern_generator/10_gc}   % short overview of humanoid walking
